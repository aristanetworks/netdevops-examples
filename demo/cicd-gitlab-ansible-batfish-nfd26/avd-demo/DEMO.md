...
![Uploaded Configlets](data/cloudvision-uploaded-configlets.png)
...
Playbook: [`playbooks/dc1-fabric-deploy-cvp.yml`](playbooks/dc1-fabric-deploy-cvp.yml)
...
- [EOS structured configuration(YAML)](inventory/intended/structured_configs/)
- [EOS configuration](inventory/intended/configs/)
- [EOS Documentation](inventory/documentation/)
- [CloudVision parameters](inventory/intended/structured_configs/cvp/cv_server.yml)
...
- Intended YAML configuration: [`inventory/intended/structured_configs`](inventory/intended/structured_configs)
- Intended EOS configuration files: [`inventory/intended/configs`](inventory/intended/configs)
- Documentation: [`inventory/documentation`](inventory/documentation)
