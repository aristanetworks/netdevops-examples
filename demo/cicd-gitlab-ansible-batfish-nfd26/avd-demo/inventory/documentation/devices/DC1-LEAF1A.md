...
| -------------- | --------------- | ------------------------- | -------------- | -------------- | ---------- | -------- | ------ |
| gzip | 10.255.0.1:9910 | UNSET | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | MGMT | MGMT | False |
...
| Port-Channel5 | DC1_L2LEAF1_Po1 | switched | trunk | 110-112,120-121,130-131 | - | - | - | - | 5 | - |
...
| Sequence | Action |
| -------- | ------ |
| 5 | deny ip any 172.22.22.0/24 |
| 10 | permit ip any host 1.1.1.3 |
| 20 | permit ip any host 8.8.8.4 |
| 30 | permit ip any host 8.8.8.8 |
| 40 | permit ip any 172.22.22.10/24 |
| 50 | permit ip any 172.22.22.40/24 |
