...
|------------------|---------------|-------------|
|  [netdevops-examples](https://github.com/aristanetworks/netdevops-examples) |  Examples of using DevOps tools with Arista EOS and CloudVision  | 2021-07-20 |
|  [ansible-cvp](https://github.com/aristanetworks/ansible-cvp) |  Ansible modules for Arista CloudVision  | 2021-07-20 |
|  [openmgmt](https://github.com/aristanetworks/openmgmt) |  Documentation and examples for using open network management tools such as OpenConfig  | 2021-07-19 |
|  [ServiceNowRac](https://github.com/aristanetworks/ServiceNowRac) |  ServiceNow RESTful Client  | 2021-07-17 |
|  [CloudVisionPortal-Examples](https://github.com/aristanetworks/CloudVisionPortal-Examples) |  A collection of CloudVision Portal examples and best practices    | 2021-07-16 |
|  [CloudEOS](https://github.com/aristanetworks/CloudEOS) |  None  | 2021-07-15 |
|  [goarista](https://github.com/aristanetworks/goarista) |  Fairly general building blocks used in Arista Go code and open-sourced for the benefit of all.  | 2021-07-15 |
|  [cvprac](https://github.com/aristanetworks/cvprac) |  None  | 2021-07-15 |
|  [cloudvision-go](https://github.com/aristanetworks/cloudvision-go) |  Go resources and libraries for integrating with Arista's CloudVision platform  | 2021-07-15 |
|  [goeapi](https://github.com/aristanetworks/goeapi) |  Go library for Arista's eAPI command API implementation  | 2021-07-14 |
|  [ansible-avd](https://github.com/aristanetworks/ansible-avd) |  Ansible Arista Validated Design  | 2021-07-14 |
|  [puppet-cloudvision](https://github.com/aristanetworks/puppet-cloudvision) |  Puppet module containing resource types for managing Arista CloudVision Portal (r) content Edit  | 2021-07-13 |
|  [ctypegen](https://github.com/aristanetworks/ctypegen) |  Generate ctypes boilerplate code from debugging information; Use python to mock C code for testing   | 2021-07-10 |
|  [sonic](https://github.com/aristanetworks/sonic) |  Open source drivers and initialization library for Arista platforms running SONiC  | 2021-07-03 |
|  [cloudvision-python](https://github.com/aristanetworks/cloudvision-python) |  Python resources and libraries for integrating with Arista's CloudVision platform   | 2021-06-29 |
|  [sonic-firmware](https://github.com/aristanetworks/sonic-firmware) |  SONiC Firmware  | 2021-06-29 |
|  [cloudvision-frontend-config](https://github.com/aristanetworks/cloudvision-frontend-config) |  JavaScript, TypeScript and Eslint configuration for CloudVision frontend libraries.  | 2021-06-26 |
|  [cloudvision](https://github.com/aristanetworks/cloudvision) |  Resources and documentation for Arista's CloudVision platform  | 2021-06-17 |
|  [go-fips](https://github.com/aristanetworks/go-fips) |  This is a fork of https://pagure.io/go with some minor changes to interface with our openssl module and to pass build tests on alpine  | 2021-06-14 |
|  [bst](https://github.com/aristanetworks/bst) |  A one-stop shop for process isolation  | 2021-06-14 |
|  [protobuf.js](https://github.com/aristanetworks/protobuf.js) |  Protocol Buffers for JavaScript (& TypeScript).  | 2021-06-10 |
|  [grpctunnel](https://github.com/aristanetworks/grpctunnel) |  A TCP-over-gRPC Tunnel  | 2021-06-01 |
|  [glog](https://github.com/aristanetworks/glog) |  Leveled execution logs for Go  | 2021-05-12 |
|  [oidc-authservice](https://github.com/aristanetworks/oidc-authservice) |  This is a fork/refactoring of the ajmyyra/ambassador-auth-oidc project  | 2021-05-12 |
|  [eoscentral](https://github.com/aristanetworks/eoscentral) |  Code examples associated with EOS Central articles.  | 2021-05-11 |
|  [cloudvision-apis](https://github.com/aristanetworks/cloudvision-apis) |  gRPC APIs for integrating with Arista's CloudVision platform   | 2021-04-20 |
|  [atd-public](https://github.com/aristanetworks/atd-public) |  None  | 2021-04-15 |
|  [hdfs](https://github.com/aristanetworks/hdfs) |  A native go client for HDFS  | 2021-04-13 |
|  [go-cvprac](https://github.com/aristanetworks/go-cvprac) |  None  | 2021-04-12 |
|  [pb](https://github.com/aristanetworks/pb) |   pb is a lightweight pastebin and url shortener built using flask.  | 2021-04-09 |
...
|  [devstack](https://github.com/aristanetworks/devstack) |  oneiric powered development environment for openstack  | 2019-04-19 |
