...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.2.113/24 | 192.168.2.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel1 | DC1-SVC3A_Po5 | 1500 | switched | trunk | 110-111,120-121,130-131,140-141,150,160-161,210-211,250,310-311,350 | - | 1 | - | - |
| Port-Channel3 | MLAG_PEER_DC1-L2LEAF5B_Po3 | 1500 | switched | trunk | 2-4094 | MLAG | - | - | - |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | DC1-SVC3A_Ethernet5 | *1500 | *switched | *trunk | *110-111,120-121,130-131,140-141,150,160-161,210-211,250,310-311,350 | - | - | - | 1 | active |
| Ethernet2 | DC1-SVC3B_Ethernet5 | *1500 | *switched | *trunk | *110-111,120-121,130-131,140-141,150,160-161,210-211,250,310-311,350 | - | - | - | 1 | active |
| Ethernet3 | MLAG_PEER_DC1-L2LEAF5B_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC1-L2LEAF5B_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *MLAG | - | - | 3 | active |
...
| --------- | ----------- | --- | ---------- | ------- | -------------------- | ------- |
| Vlan4094 | MLAG_PEER | Global Routing Table  | 10.255.252.18/31 | - | - | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L2LEAF5 | Vlan4094 | 10.255.252.19 | Port-Channel3 |
