...
Et1                            up             up                 P2P_LINK_TO_DC-SPINE1_Ethernet2
Et2                            up             up                 P2P_LINK_TO_DC-SPINE2_Ethernet2
Et3                            up             up                 
Et4                            up             up                 
Et5                            up             up                 server01_E2
Et6                            up             up                 server02_E2
Et7                            up             up                 server03_E2
Et8                            up             up                 server04_E1
Et9                            up             up                 
Et10                           up             up                 
Et11                           up             up                 
...
--------------- -------------------- ---------- ------------ ---------- ------- 
Ethernet1       10.10.100.5/31       up         up              1500            
Ethernet2       10.10.100.7/31       up         up              1500            
Loopback0       192.168.100.4/32     up         up             65535            
Loopback1       192.168.101.4/32     up         up             65535            
Loopback100     10.255.1.4/32        up         up             65535            
Loopback200     10.255.2.4/32        up         up             65535            
Management1     172.30.30.214/24     up         up              1500            
...
```
Last table change time   : 0:27:32 ago
...
---------- -------------------------- ---------------------- --- 
Et1           DC-SPINE1.homelab.io       Ethernet2           120 
Et2           DC-SPINE2.homelab.io       Ethernet2           120 
Et5           server01                   Ethernet2           120 
Et6           server02                   Ethernet2           120 
Et7           server03                   Ethernet2           120 
Et8           server04                   Ethernet1           120 
Ma1           mgmt-sw                    Ethernet10          120
```
## show running-config

```
! Command: show running-config
! device: DC-LEAF2 (vEOS, EOS-4.25.5M)
!
...
Hardware version: 
Serial number: 
Hardware MAC address: 5001.44f9.27d6
System MAC address: 5001.44f9.27d6
