...
Et1                            up             up                 P2P_LINK_TO_DC-SPINE1_Ethernet3
Et2                            up             up                 P2P_LINK_TO_DC-SPINE2_Ethernet3
Et3                            up             up                 
Et4                            up             up                 
Et5                            up             up                 server05_E1
Et6                            up             up                 server06_E1
Et7                            up             up                 server03_E3
Et8                            up             up                 server04_E2
Et9                            up             up                 
Et10                           up             up                 
Et11                           up             up                 
...
Po5                            up             up                 server05_PortChannel
Po6                            up             up                 server06_PortChannel
Po7                            up             up                 server03_PortChannel
Po8                            up             up                 server04_PortChannel
Vl10                           up             up                 Tenant_blue_compute
Vl30                           up             up                 Tenant_green_storage
Vl40                           up             up                 Tenant_red_storage
Vl50                           up             up                 Tenant_blue_storage
Vl1197                         up             up                 
Vl1198                         up             up                 
Vl1199                         up             up                 
Vx1                            up             up
...
--------------- -------------------- ---------- ------------ ---------- ------- 
Ethernet1       10.10.100.9/31       up         up              1500            
Ethernet2       10.10.100.11/31      up         up              1500            
Loopback0       192.168.100.5/32     up         up             65535            
Loopback1       192.168.101.5/32     up         up             65535            
Loopback100     10.255.1.5/32        up         up             65535            
Loopback200     10.255.2.5/32        up         up             65535            
Management1     172.30.30.215/24     up         up              1500            
Vlan10          10.10.10.1/24        up         up              1500            
Vlan30          10.10.30.1/24        up         up              1500            
Vlan40          10.10.40.1/24        up         up              1500            
Vlan50          10.10.50.1/24        up         up              1500            
...
---------- -------------------------- ---------------------- --- 
Et1           DC-SPINE1.homelab.io       Ethernet3           120 
Et2           DC-SPINE2.homelab.io       Ethernet3           120 
Et5           server05                   Ethernet1           120 
Et6           server06                   Ethernet1           120 
Et7           server03                   Ethernet3           120 
Et8           server04                   Ethernet2           120 
Ma1           mgmt-sw                    Ethernet11          120
```
## show running-config

```
! Command: show running-config
! device: DC-LEAF3 (vEOS, EOS-4.25.5M)
!
...
Hardware version: 
Serial number: 
Hardware MAC address: 5001.5510.1e93
System MAC address: 5001.5510.1e93
